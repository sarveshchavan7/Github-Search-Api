package com.example.githubsearchapi.data.model.api.searchrepositories;
...
public class Items {
    ...
    public static DiffUtil.ItemCallback<Items> DIFF_CALLBACK = new DiffUtil.ItemCallback<Items>() {
        @Override
